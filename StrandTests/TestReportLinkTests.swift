...
/// labels, with every component percent-encoded. The repo is MatB57/noop (this fork's own tracker).
final class TestReportLinkTests: XCTestCase {
    ...
    func testSleepProfileURLEncodesEveryFieldAndLabel() {
        ...
        XCTAssertTrue(s.hasPrefix("https://github.com/MatB57/noop/issues/new?"))
