...
> [Releases](https://github.com/MatB57/noop/releases) page and install it with **AltStore** or **SideStore** — see
...
2. **Download `NOOP-v<version>-ios.ipa`** from [Releases](https://github.com/MatB57/noop/releases) to your iPhone (or your
...
**Source URL:** `https://raw.githubusercontent.com/MatB57/noop/main/altstore-source.json`
