...
fun NoopRoot() {
    ...
    // Sideloaded-APK update prompt: a throttled launch check against the public GitHub release,
    // with a one-tap in-app download + install. Onboarded users only (past Terms + onboarding).
    UpdateGate()
